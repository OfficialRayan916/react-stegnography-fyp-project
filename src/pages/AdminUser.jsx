...
const USERS = [
  { id: "2291", name: "Jordan Diaz", email: "jordan.diaz@mail.com", enc: 482, dec: 356, ratio: 70 },
  { id: "1187", name: "Amara Khan", email: "amara.khan@mail.com", enc: 1204, dec: 1098, ratio: 90 },
  { id: "0934", name: "Ravi Menon", email: "ravi.menon@mail.com", enc: 76, dec: 210, ratio: 25 },
  { id: "3352", name: "Sofia Conti", email: "sofia.conti@mail.com", enc: 640, dec: 598, ratio: 88 },
];
...
export default function AdminUsers() {
  ...
  const totalEncoded = USERS.reduce((sum, u) => sum + u.enc, 0);
  const totalDecoded = USERS.reduce((sum, u) => sum + u.dec, 0);
  const activeToday = 3;
          ...
          <div className={styles.tableCard}>
            ...
            {filteredUsers.map((u) => (
              <div key={u.id} className={styles.tableRow}>
                ...
                <div className={styles.colNum}>{u.enc.toLocaleString()}</div>
                <div className={styles.colNum}>{u.dec.toLocaleString()}</div>
                <div className={styles.colRatio}>
                  <div className={styles.progressTrack}>
                    <div className={styles.progressFill} style={{ width: `${u.ratio}%` }} />
                  </div>
                </div>
                <div className={styles.colChevron}>
